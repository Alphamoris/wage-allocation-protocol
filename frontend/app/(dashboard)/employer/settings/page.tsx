...
import {
  ...
  Mail, Phone, Building, MapPin, FileText, Key, Lock,
  RefreshCw, Trash2, ChevronRight
} from "lucide-react";
                ...
                <div className="p-6 border-b border-wap-border">
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-lg bg-wap-section">
                      <Building className="w-5 h-5 text-wap-coral" />
                    </div>
                    <div>
                      <h2 className="text-lg font-semibold text-wap-text-primary">Company Profile</h2>
                      <p className="text-sm text-wap-text-tertiary">Manage your company information</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-wap-text-tertiary" />
                        <input
                          type="tel"
                          value={phone}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-wap-text-tertiary" />
                        <input
                          type="text"
            ...
            {activeTab === "notifications" && (
              <div className="bg-white rounded-2xl border border-wap-border shadow-sm overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                  {[
                    { key: "streamCreated" as const, label: "Stream Created", desc: "When a new wage stream is created" },
                    { key: "streamCompleted" as const, label: "Stream Completed", desc: "When a wage stream is completed" },
                    { key: "lowBalance" as const, label: "Low Balance Alert", desc: "When treasury balance is running low" },
                    { key: "withdrawals" as const, label: "Employee Withdrawals", desc: "When an employee withdraws wages" },
              ...
              <div className="bg-white rounded-2xl border border-wap-border shadow-sm overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="flex items-center justify-between p-4 rounded-xl bg-wap-section">
                    ...
                    <button
                      className="relative w-12 h-6 rounded-full bg-wap-green transition-colors"
                    >
